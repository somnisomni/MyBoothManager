...
export default class MBMSequelize {
  ...
  static get instance(): Sequelize {
    if(!MBMSequelize._instance) {
      throw new Error("Sequelize instance is not initialized! You need to set-up the instance using setup() function first.");
    }
