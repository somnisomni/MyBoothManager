...
export class UpdateBoothRequestDto extends PartialType(OmitType(CreateBoothRequestDto, ["fairId", "currencyCode"] as const)) implements Omit<IBoothUpdateRequest, "datesOpenInFair"> {
