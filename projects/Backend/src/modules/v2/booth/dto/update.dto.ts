...
export class UpdateBoothRequestDto
  extends PartialType(OmitType(CreateBoothRequestDto, ["fairId", "currencySymbol"] as const))
  implements Omit<IBoothUpdateRequest, "datesOpenInFair"> {
