  ...
  <div class="root">
    ...
    <VNavigationDrawer v-model="navOpen"
      ...
      <VList nav
        ...
        <VListItem prependIcon="mdi-view-dashboard"
                   title="대시보드"
                   value="dashboard"
                   :to="{ name: 'admin' }"
                   exact />
        <VListItem prependIcon="mdi-store-cog"
                   title="부스 정보 / 인포"
                   value="info"
                   :to="{ name: 'admin-info' }"
                   exact />
        <VListItem prependIcon="mdi-gift-open"
                   title="굿즈"
                   value="goods"
                   :to="{ name: 'admin-goods' }"
                   exact />
        <VListItem prependIcon="mdi-receipt-text"
                   title="판매 기록"
                   value="orders"
                   :to="{ name: 'admin-orders' }"
                   exact />
        <VListItem prependIcon="mdi-chart-bar"
                   title="통계"
                   value="analytics"
