            ...
            <VLayout class="px-2">
              <div v-if="!isRemainingStockMismatchWithOrderHistory"
                ...
                <VIcon icon="mdi-check-circle-outline"
                       size="x-large" />
                <span class="mt-2"
                      style="word-break: keep-all; font-size: 0.9em; line-height: 1.2;"> 판매 기록과 등록된 굿즈들의 재고 개수 차이가 일치함</span>
              </div>
              <div v-else
                ...
                <VIcon icon="mdi-alert-outline"
                       size="x-large" />
                <span class="mt-2"
                      style="word-break: keep-all; font-size: 0.9em; line-height: 1.2;"> 판매 기록과 등록된 굿즈들의 재고 개수 차이가 일치하지 않음
