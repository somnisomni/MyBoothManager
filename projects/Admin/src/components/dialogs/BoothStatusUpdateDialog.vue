<template>
  <CommonDialog v-model="open"
      ...
      <div v-else-if="targetStatusIsClosing">
        <p>부스가 운영 종료 상태인 경우,</p><br />
        <ul>
          <li>메인 페이지 부스 목록에서 보여지지 않게 됩니다.</li>
          <li>굿즈 정보를 수정할 수 없게 됩니다.</li>
          <li>부스 정보 공개 설정 시, 부스 공개 페이지의 URL을 직접 입력하여 접속할 경우 계속해서 부스 정보를 열람할 수 있습니다.</li>
        </ul><br/>
        <p>부스 정보 공개 여부는 부스 운영 상태를 변경한 후 설정할 수 있습니다.</p>
      </div>
